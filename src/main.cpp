...
{
	KAboutData about("kgeography", I18N_NOOP("KGeography"), "0.4.3", I18N_NOOP("A geography learning program"), KAboutData::License_GPL, "© 2004-2005 Albert Astals Cid", 0, "http://kgeography.berlios.de");
