...
{
	KAboutData about("kgeography", 0, ki18n("KGeography"), "0.5.9", ki18n("A geography learning program"), KAboutData::License_GPL, ki18n("© 2004-2005 Albert Astals Cid"), KLocalizedString(), "http://kgeography.berlios.de");
