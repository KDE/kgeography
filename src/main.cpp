...
{
	KAboutData about("kgeography", I18N_NOOP("KGeography"), "0.3", I18N_NOOP("A geography learning program"), KAboutData::License_GPL, 0, 0, "http://kgeography.berlios.de", "tsdgeos@terra.es");
